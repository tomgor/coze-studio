...
type ResponseStyle struct {
	WorkflowResponseMode WorkflowResponseMode `thrift:"workflow_response_mode,1,default,WorkflowResponseMode" form:"workflow_response_mode" json:"workflow_response_mode" query:"workflow_response_mode"`
}
...
type APIListOrder struct {
	OrderBy APIListOrderBy `thrift:"order_by,1,default,APIListOrderBy" form:"order_by" json:"order_by" query:"order_by"`
...
type PluginMetaInfo struct {
	...
	AuthType []AuthorizationType `thrift:"auth_type,5,default,list<AuthorizationType>" form:"auth_type" json:"auth_type" query:"auth_type"`
	// When the sub-authorization type is api/token, the token parameter position
	Location *AuthorizationServiceLocation `thrift:"location,6,optional,AuthorizationServiceLocation" form:"location" json:"location,omitempty" query:"location"`
	...
	CommonParams map[ParameterLocation][]*CommonParamSchema `thrift:"common_params,10,optional,map<ParameterLocation:list<CommonParamSchema>>" form:"common_params" json:"common_params,omitempty" query:"common_params"`
...
type GetPlaygroundPluginListData struct {
	PluginList []*PluginInfoForPlayground `thrift:"plugin_list,1,default,list<PluginInfoForPlayground>" form:"plugin_list" json:"plugin_list"`
...
type PluginInfoForPlayground struct {
	...
	PluginType   PluginType   `thrift:"plugin_type,5,default,PluginType" form:"plugin_type" json:"plugin_type" query:"plugin_type"`
	Status       PluginStatus `thrift:"status,6,default,PluginStatus" form:"status" json:"status" query:"status"`
	...
	PluginApis   []*PluginApi `thrift:"plugin_apis,15,default,list<PluginApi>" form:"plugin_apis" json:"plugin_apis" query:"plugin_apis"`
	// plugin tag
	...
	CommonParams  map[ParameterLocation][]*CommonParamSchema `thrift:"common_params,25,optional,map<ParameterLocation:list<CommonParamSchema>>" form:"common_params" json:"common_params,omitempty" query:"common_params"`
	// Product status of the plugin
	PluginProductStatus ProductStatus `thrift:"plugin_product_status,26,default,ProductStatus" form:"plugin_product_status" json:"plugin_product_status" query:"plugin_product_status"`
	// Plugin product removal type
	PluginProductUnlistType ProductUnlistType `thrift:"plugin_product_unlist_type,27,default,ProductUnlistType" form:"plugin_product_unlist_type" json:"plugin_product_unlist_type" query:"plugin_product_unlist_type"`
	// Material ID
	...
	CreationMethod CreationMethod `thrift:"creation_method,30,default,CreationMethod" form:"creation_method" json:"creation_method" query:"creation_method"`
...
type PluginApi struct {
	...
	// summary
	Desc       string             `thrift:"desc,2" form:"desc" json:"desc" query:"desc"`
	Parameters []*PluginParameter `thrift:"parameters,3,default,list<PluginParameter>" form:"parameters" json:"parameters" query:"parameters"`
	...
	// operating mode
	RunMode RunMode `thrift:"run_mode,12,default,RunMode" form:"run_mode" json:"run_mode" query:"run_mode"`
}
...
type Creator struct {
	...
	SpaceRolyType SpaceRoleType `thrift:"space_roly_type,5,default,SpaceRoleType" form:"space_roly_type" json:"space_roly_type" query:"space_roly_type"`
	// user name
...
type PluginParameter struct {
	...
	SubParameters []*PluginParameter `thrift:"sub_parameters,5,default,list<PluginParameter>" form:"sub_parameters" json:"sub_parameters" query:"sub_parameters"`
	...
	FromOutput []string `thrift:"from_output,8,optional,list<string>" form:"from_output" json:"from_output,omitempty" query:"from_output"`
	...
	// Format parameter
	Format *PluginParamTypeFormat `thrift:"format,10,optional,PluginParamTypeFormat" form:"format" json:"format,omitempty" query:"format"`
}
...
type PluginAPIInfo struct {
	...
	Method         APIMethod       `thrift:"method,6,default,APIMethod" form:"method" json:"method" query:"method"`
	RequestParams  []*APIParameter `thrift:"request_params,7,default,list<APIParameter>" form:"request_params" json:"request_params" query:"request_params"`
	ResponseParams []*APIParameter `thrift:"response_params,8,default,list<APIParameter>" form:"response_params" json:"response_params" query:"response_params"`
	CreateTime     string          `thrift:"create_time,9" form:"create_time" json:"create_time" query:"create_time"`
	DebugStatus    APIDebugStatus  `thrift:"debug_status,10,default,APIDebugStatus" form:"debug_status" json:"debug_status" query:"debug_status"`
	// ignore
	...
	OnlineStatus OnlineStatus `thrift:"online_status,13,default,OnlineStatus" form:"online_status" json:"online_status" query:"online_status"`
	// ignore
	...
	// Debug sample state
	DebugExampleStatus DebugExampleStatus `thrift:"debug_example_status,17,default,DebugExampleStatus" form:"debug_example_status" json:"debug_example_status" query:"debug_example_status"`
	// ignore
...
type APIParameter struct {
	...
	// parameter type
	Type ParameterType `thrift:"type,4,default,ParameterType" form:"type" json:"type" query:"type"`
	// negligible
	SubType *ParameterType `thrift:"sub_type,5,optional,ParameterType" form:"sub_type" json:"sub_type,omitempty" query:"sub_type"`
	// parameter location
	Location ParameterLocation `thrift:"location,6,default,ParameterLocation" form:"location" json:"location" query:"location"`
	// Is it required?
	IsRequired bool `thrift:"is_required,7" form:"is_required" json:"is_required" query:"is_required"`
	// sub-parameter
	SubParameters []*APIParameter `thrift:"sub_parameters,8,default,list<APIParameter>" form:"sub_parameters" json:"sub_parameters" query:"sub_parameters"`
	// global default
	...
	// negligible
	DefaultParamSource *DefaultParamSource `thrift:"default_param_source,13,optional,DefaultParamSource" form:"default_param_source" json:"default_param_source,omitempty" query:"default_param_source"`
	...
	AssistType *AssistParameterType `thrift:"assist_type,15,optional,AssistParameterType" form:"assist_type" json:"assist_type,omitempty" query:"assist_type"`
}
...
type APIExtend struct {
	...
	AuthMode PluginToolAuthType `thrift:"auth_mode,1,default,PluginToolAuthType" form:"auth_mode" json:"auth_mode" query:"auth_mode"`
}
...
type PresetCardBindingInfo struct {
	...
	Status         PluginCardStatus `thrift:"status,3,default,PluginCardStatus" form:"status" json:"status" query:"status"`
	// thumbnail
