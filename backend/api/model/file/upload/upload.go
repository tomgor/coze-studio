...
type UploadAddress struct {
	StoreInfos   []*StoreInfo      `thrift:"StoreInfos,1,required,list<StoreInfo>" form:"StoreInfos,required" json:"StoreInfos,required" query:"StoreInfos,required"`
	UploadHosts  []string          `thrift:"UploadHosts,2,required,list<string>" form:"UploadHosts,required" json:"UploadHosts,required" query:"UploadHosts,required"`
...
type InnerUploadAddress struct {
	UploadNodes []*UploadNode `thrift:"UploadNodes,1,required,list<UploadNode>" form:"UploadNodes,required" json:"UploadNodes,required" query:"UploadNodes,required"`
}
...
type ApplyUploadActionResult struct {
	...
	Results               []*UploadResult     `thrift:"Results,6,optional,list<UploadResult>" form:"Results" json:"Results,omitempty" query:"Results"`
	PluginResult          []*PluginResult     `thrift:"PluginResult,7,optional,list<PluginResult>" form:"PluginResult" json:"PluginResult,omitempty" query:"PluginResult"`
}
