...
type PassportSimpleSsoLoginPostRequest struct {
	Platform string `thrift:"platform,6,required" form:"platform,required" json:"platform,required" query:"platform,required"`
	Key      string `thrift:"key,7,required" form:"key,required" json:"key,required" query:"key,required"`
	Payload  string `thrift:"payload,8,required" form:"payload,required" json:"payload,required" query:"payload,required"`
}

func NewPassportSimpleSsoLoginPostRequest() *PassportSimpleSsoLoginPostRequest {
	return &PassportSimpleSsoLoginPostRequest{}
}

func (p *PassportSimpleSsoLoginPostRequest) InitDefault() {
}

func (p *PassportSimpleSsoLoginPostRequest) GetPlatform() (v string) {
	return p.Platform
}

func (p *PassportSimpleSsoLoginPostRequest) GetKey() (v string) {
	return p.Key
}

func (p *PassportSimpleSsoLoginPostRequest) GetPayload() (v string) {
	return p.Payload
}

var fieldIDToName_PassportSimpleSsoLoginPostRequest = map[int16]string{
	6: "platform",
	7: "key",
	8: "payload",
}

func (p *PassportSimpleSsoLoginPostRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_PassportSimpleSsoLoginPostRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_PassportSimpleSsoLoginPostRequest[fieldId]))
}

func (p *PassportSimpleSsoLoginPostRequest) ReadField6(iprot thrift.TProtocol) error {
...
func (p *PassportSimpleSsoLoginPostRequest) ReadField7(iprot thrift.TProtocol) error {
...
func (p *PassportSimpleSsoLoginPostRequest) ReadField8(iprot thrift.TProtocol) error {
...
func (p *PassportSimpleSsoLoginPostRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassportSimpleSsoLoginPostRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField6(oprot); err != nil {
...
func (p *PassportSimpleSsoLoginPostRequest) writeField6(oprot thrift.TProtocol) (err error) {
...
func (p *PassportSimpleSsoLoginPostRequest) writeField7(oprot thrift.TProtocol) (err error) {
...
func (p *PassportSimpleSsoLoginPostRequest) writeField8(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("payload", thrift.STRING, 8); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *PassportSimpleSsoLoginPostRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PassportSimpleSsoLoginPostRequest(%+v)", *p)
...
type PassportService interface {
	...
	PassportWebSimpleSsoLoginPost(ctx context.Context, req *PassportSimpleSsoLoginPostRequest) (r *PassportWebEmailLoginPostResponse, err error)
...
func (p *PassportServiceClient) PassportWebSimpleSsoLoginPost(ctx context.Context, req *PassportSimpleSsoLoginPostRequest) (r *PassportWebEmailLoginPostResponse, err error) {
	var _args PassportServicePassportWebSimpleSsoLoginPostArgs
	_args.Req = req
	var _result PassportServicePassportWebSimpleSsoLoginPostResult
	if err = p.Client_().Call(ctx, "PassportWebSimpleSsoLoginPost", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewPassportServiceProcessor(handler PassportService) *PassportServiceProcessor {
	...
	self.AddToProcessorMap("PassportWebSimpleSsoLoginPost", &passportServiceProcessorPassportWebSimpleSsoLoginPost{handler: handler})
...
type passportServiceProcessorPassportWebSimpleSsoLoginPost struct {
	handler PassportService
}

func (p *passportServiceProcessorPassportWebSimpleSsoLoginPost) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := PassportServicePassportWebSimpleSsoLoginPostArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("PassportWebSimpleSsoLoginPost", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := PassportServicePassportWebSimpleSsoLoginPostResult{}
	var retval *PassportWebEmailLoginPostResponse
	if retval, err2 = p.handler.PassportWebSimpleSsoLoginPost(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing PassportWebSimpleSsoLoginPost: "+err2.Error())
		oprot.WriteMessageBegin("PassportWebSimpleSsoLoginPost", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("PassportWebSimpleSsoLoginPost", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type PassportServicePassportWebSimpleSsoLoginPostArgs struct {
	Req *PassportSimpleSsoLoginPostRequest `thrift:"req,1"`
}

func NewPassportServicePassportWebSimpleSsoLoginPostArgs() *PassportServicePassportWebSimpleSsoLoginPostArgs {
	return &PassportServicePassportWebSimpleSsoLoginPostArgs{}
}

func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) InitDefault() {
}

var PassportServicePassportWebSimpleSsoLoginPostArgs_Req_DEFAULT *PassportSimpleSsoLoginPostRequest

func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) GetReq() (v *PassportSimpleSsoLoginPostRequest) {
	if !p.IsSetReq() {
		return PassportServicePassportWebSimpleSsoLoginPostArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_PassportServicePassportWebSimpleSsoLoginPostArgs = map[int16]string{
	1: "req",
}

func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_PassportServicePassportWebSimpleSsoLoginPostArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewPassportSimpleSsoLoginPostRequest()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassportWebSimpleSsoLoginPost_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *PassportServicePassportWebSimpleSsoLoginPostArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PassportServicePassportWebSimpleSsoLoginPostArgs(%+v)", *p)

}

type PassportServicePassportWebSimpleSsoLoginPostResult struct {
	Success *PassportWebEmailLoginPostResponse `thrift:"success,0,optional"`
}

func NewPassportServicePassportWebSimpleSsoLoginPostResult() *PassportServicePassportWebSimpleSsoLoginPostResult {
	return &PassportServicePassportWebSimpleSsoLoginPostResult{}
}

func (p *PassportServicePassportWebSimpleSsoLoginPostResult) InitDefault() {
}

var PassportServicePassportWebSimpleSsoLoginPostResult_Success_DEFAULT *PassportWebEmailLoginPostResponse

func (p *PassportServicePassportWebSimpleSsoLoginPostResult) GetSuccess() (v *PassportWebEmailLoginPostResponse) {
	if !p.IsSetSuccess() {
		return PassportServicePassportWebSimpleSsoLoginPostResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_PassportServicePassportWebSimpleSsoLoginPostResult = map[int16]string{
	0: "success",
}

func (p *PassportServicePassportWebSimpleSsoLoginPostResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *PassportServicePassportWebSimpleSsoLoginPostResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_PassportServicePassportWebSimpleSsoLoginPostResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *PassportServicePassportWebSimpleSsoLoginPostResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewPassportWebEmailLoginPostResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *PassportServicePassportWebSimpleSsoLoginPostResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassportWebSimpleSsoLoginPost_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *PassportServicePassportWebSimpleSsoLoginPostResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *PassportServicePassportWebSimpleSsoLoginPostResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PassportServicePassportWebSimpleSsoLoginPostResult(%+v)", *p)
