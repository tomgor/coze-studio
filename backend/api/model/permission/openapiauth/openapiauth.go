...
type ListPersonalAccessTokensResponseData struct {
	// PAT list
	PersonalAccessTokens []*PersonalAccessTokenWithCreatorInfo `thrift:"personal_access_tokens,1,required,list<PersonalAccessTokenWithCreatorInfo>" form:"personal_access_tokens,required" json:"personal_access_tokens,required" query:"personal_access_tokens,required"`
