...
type IntelligencePublishInfo struct {
	...
	Connectors   []*ConnectorInfo `thrift:"connectors,3,default,list<ConnectorInfo>" form:"connectors" json:"connectors" query:"connectors"`
}
...
type Space struct {
	...
	Status  SpaceStatus `thrift:"status,3,default,SpaceStatus" form:"status" json:"status" query:"status"`
