...
type DraftBotCreateRequest struct {
	...
	Visibility       VisibilityType    `thrift:"visibility,5,default,VisibilityType" form:"visibility" json:"visibility" query:"visibility"`
	...
	BusinessType *bot_common.BusinessType `thrift:"business_type,9,optional,BusinessType" form:"business_type" json:"business_type,omitempty" query:"business_type"`
}
...
type TabDisplayItems struct {
	PluginTabStatus           *TabStatus `thrift:"plugin_tab_status,1,optional,TabStatus" form:"plugin_tab_status" json:"plugin_tab_status,omitempty" query:"plugin_tab_status"`
	WorkflowTabStatus         *TabStatus `thrift:"workflow_tab_status,2,optional,TabStatus" form:"workflow_tab_status" json:"workflow_tab_status,omitempty" query:"workflow_tab_status"`
	KnowledgeTabStatus        *TabStatus `thrift:"knowledge_tab_status,3,optional,TabStatus" form:"knowledge_tab_status" json:"knowledge_tab_status,omitempty" query:"knowledge_tab_status"`
	DatabaseTabStatus         *TabStatus `thrift:"database_tab_status,4,optional,TabStatus" form:"database_tab_status" json:"database_tab_status,omitempty" query:"database_tab_status"`
	VariableTabStatus         *TabStatus `thrift:"variable_tab_status,5,optional,TabStatus" form:"variable_tab_status" json:"variable_tab_status,omitempty" query:"variable_tab_status"`
	OpeningDialogTabStatus    *TabStatus `thrift:"opening_dialog_tab_status,6,optional,TabStatus" form:"opening_dialog_tab_status" json:"opening_dialog_tab_status,omitempty" query:"opening_dialog_tab_status"`
	ScheduledTaskTabStatus    *TabStatus `thrift:"scheduled_task_tab_status,7,optional,TabStatus" form:"scheduled_task_tab_status" json:"scheduled_task_tab_status,omitempty" query:"scheduled_task_tab_status"`
	SuggestionTabStatus       *TabStatus `thrift:"suggestion_tab_status,8,optional,TabStatus" form:"suggestion_tab_status" json:"suggestion_tab_status,omitempty" query:"suggestion_tab_status"`
	TtsTabStatus              *TabStatus `thrift:"tts_tab_status,9,optional,TabStatus" form:"tts_tab_status" json:"tts_tab_status,omitempty" query:"tts_tab_status"`
	FileboxTabStatus          *TabStatus `thrift:"filebox_tab_status,10,optional,TabStatus" form:"filebox_tab_status" json:"filebox_tab_status,omitempty" query:"filebox_tab_status"`
	LongTermMemoryTabStatus   *TabStatus `thrift:"long_term_memory_tab_status,11,optional,TabStatus" form:"long_term_memory_tab_status" json:"long_term_memory_tab_status,omitempty" query:"long_term_memory_tab_status"`
	AnswerActionTabStatus     *TabStatus `thrift:"answer_action_tab_status,12,optional,TabStatus" form:"answer_action_tab_status" json:"answer_action_tab_status,omitempty" query:"answer_action_tab_status"`
	ImageflowTabStatus        *TabStatus `thrift:"imageflow_tab_status,13,optional,TabStatus" form:"imageflow_tab_status" json:"imageflow_tab_status,omitempty" query:"imageflow_tab_status"`
	BackgroundImageTabStatus  *TabStatus `thrift:"background_image_tab_status,14,optional,TabStatus" form:"background_image_tab_status" json:"background_image_tab_status,omitempty" query:"background_image_tab_status"`
	ShortcutTabStatus         *TabStatus `thrift:"shortcut_tab_status,15,optional,TabStatus" form:"shortcut_tab_status" json:"shortcut_tab_status,omitempty" query:"shortcut_tab_status"`
	KnowledgeTableTabStatus   *TabStatus `thrift:"knowledge_table_tab_status,16,optional,TabStatus" form:"knowledge_table_tab_status" json:"knowledge_table_tab_status,omitempty" query:"knowledge_table_tab_status"`
	KnowledgeTextTabStatus    *TabStatus `thrift:"knowledge_text_tab_status,17,optional,TabStatus" form:"knowledge_text_tab_status" json:"knowledge_text_tab_status,omitempty" query:"knowledge_text_tab_status"`
	KnowledgePhotoTabStatus   *TabStatus `thrift:"knowledge_photo_tab_status,18,optional,TabStatus" form:"knowledge_photo_tab_status" json:"knowledge_photo_tab_status,omitempty" query:"knowledge_photo_tab_status"`
	HookInfoTabStatus         *TabStatus `thrift:"hook_info_tab_status,19,optional,TabStatus" form:"hook_info_tab_status" json:"hook_info_tab_status,omitempty" query:"hook_info_tab_status"`
	DefaultUserInputTabStatus *TabStatus `thrift:"default_user_input_tab_status,20,optional,TabStatus" form:"default_user_input_tab_status" json:"default_user_input_tab_status,omitempty" query:"default_user_input_tab_status"`
}
...
type PublishDraftBotData struct {
	...
	ConnectorBindResult map[string][]*ConnectorBindResult `thrift:"connector_bind_result,1,default,map<string:list<ConnectorBindResult>>" form:"connector_bind_result" json:"connector_bind_result" query:"connector_bind_result"`
	...
	NotPassReason []string `thrift:"not_pass_reason,6,optional,list<string>" form:"not_pass_reason" json:"not_pass_reason,omitempty" query:"not_pass_reason"`
...
type ConnectorBindResult struct {
	...
	// post result status
	PublishResultStatus *PublishResultStatus `thrift:"publish_result_status,4,optional,PublishResultStatus" form:"publish_result_status" json:"publish_result_status,omitempty" query:"publish_result_status"`
}
...
type AgentInfo struct {
	...
	AgentType      *AgentType     `thrift:"agent_type,2,optional,AgentType" form:"agent_type" json:"agent_type,omitempty" query:"agent_type"`
	...
	Intents        []*Intent      `thrift:"intents,6,optional,list<Intent>" form:"intents" json:"intents,omitempty" query:"intents"`
	...
	ReferenceInfoStatus *ReferenceInfoStatus `thrift:"reference_info_status,11,optional,ReferenceInfoStatus" form:"reference_info_status" json:"reference_info_status,omitempty" query:"reference_info_status"`
	Description         *string              `thrift:"description,12,optional" form:"description" json:"description,omitempty" query:"description"`
	UpdateType          *ReferenceUpdateType `thrift:"update_type,13,optional,ReferenceUpdateType" form:"update_type" json:"update_type,omitempty" query:"update_type"`
}
...
type PublishDraftBotRequest struct {
	...
	// Key represents connector_name enumeration Feishu = "feishu" -- obsolete
	ConnectorList map[string][]*Connector `thrift:"connector_list,4,default,map<string:list<Connector>>" form:"connector_list" json:"connector_list" query:"connector_list"`
	...
	// Default 0
	BotMode    *BotMode      `thrift:"botMode,6,optional,BotMode" form:"botMode" json:"botMode,omitempty" query:"botMode"`
	Agents     []*AgentInfo  `thrift:"agents,7,optional,list<AgentInfo>" form:"agents" json:"agents,omitempty" query:"agents"`
	CanvasData *string       `thrift:"canvas_data,8,optional" form:"canvas_data" json:"canvas_data,omitempty" query:"canvas_data"`
	BotTagInfo []*BotTagInfo `thrift:"bot_tag_info,9,optional,list<BotTagInfo>" form:"bot_tag_info" json:"bot_tag_info,omitempty" query:"bot_tag_info"`
	...
	PublishType *PublishType `thrift:"publish_type,13,optional,PublishType" form:"publish_type" json:"publish_type,omitempty" query:"publish_type"`
...
type ListDraftBotHistoryRequest struct {
	...
	HistoryType HistoryType `thrift:"history_type,5,required,HistoryType" form:"history_type,required" json:"history_type,required" query:"history_type,required"`
...
type ListDraftBotHistoryData struct {
	HistoryInfos []*HistoryInfo `thrift:"history_infos,1,default,list<HistoryInfo>" form:"history_infos" json:"history_infos" query:"history_infos"`
...
type HistoryInfo struct {
	...
	HistoryType HistoryType `thrift:"history_type,2,default,HistoryType" form:"history_type" json:"history_type" query:"history_type"`
	...
	ConnectorInfos []*ConnectorInfo `thrift:"connector_infos,5,default,list<ConnectorInfo>" form:"connector_infos" json:"connector_infos" query:"connector_infos"`
...
type GetIconRequest struct {
	IconType IconType `thrift:"icon_type,1,default,IconType" form:"icon_type" json:"icon_type" query:"icon_type"`
}
...
type GetIconResponseData struct {
	IconList []*Icon `thrift:"icon_list,1,default,list<Icon>" form:"icon_list" json:"icon_list" query:"icon_list"`
}
...
type CommonFileInfo struct {
	...
	// business type
	BizType FileBizType `thrift:"biz_type,2,default,FileBizType" form:"biz_type" json:"biz_type" query:"biz_type"`
}
...
type GetTypeListRequest struct {
	...
	CurModelIds []string `thrift:"cur_model_ids,6,optional,list<string>" form:"cur_model_ids" json:"cur_model_ids,omitempty" query:"cur_model_ids"`
	// model scenario
	ModelScene *ModelScene `thrift:"model_scene,7,optional,ModelScene" form:"model_scene" json:"model_scene,omitempty" query:"model_scene"`
}
...
type ModelParameter struct {
	...
	// type
	Type ModelParamType `thrift:"type,4,required,ModelParamType" form:"type,required" json:"type,required" query:"type,required"`
	...
	Options []*Option `thrift:"options,9,default,list<Option>" form:"options" json:"options" query:"options"`
...
type ModelDescGroup struct {
	...
	Desc      []string `thrift:"desc,2,default,list<string>" form:"desc" json:"desc" query:"desc"`
}
...
type ModelTag struct {
	...
	TagClass        ModelTagClass `thrift:"tag_class,2,default,ModelTagClass" form:"tag_class" json:"tag_class" query:"tag_class"`
...
type ModelStatusDetails struct {
	...
	// Model Features
	ModelFeature ModelTagValue `thrift:"model_feature,22,default,ModelTagValue" form:"model_feature" json:"model_feature" query:"model_feature"`
}
...
type Model struct {
	...
	ModelClass ModelClass `thrift:"model_class,3,default,ModelClass" form:"model_class" json:"model_class" query:"model_class"`
	// Model icon url
	...
	ModelParams    []*ModelParameter `thrift:"model_params,11,default,list<ModelParameter>" form:"model_params" json:"model_params" query:"model_params"`
	ModelDesc      []*ModelDescGroup `thrift:"model_desc,12,optional,list<ModelDescGroup>" form:"model_desc" json:"model_desc,omitempty" query:"model_desc"`
	// model function configuration
	FuncConfig map[bot_common.ModelFuncConfigType]bot_common.ModelFuncConfigStatus `thrift:"func_config,13,optional,map<ModelFuncConfigType:ModelFuncConfigStatus>" form:"func_config" json:"func_config,omitempty" query:"func_config"`
	// Ark model node name
	EndpointName *string `thrift:"endpoint_name,14,optional" form:"endpoint_name" json:"endpoint_name,omitempty" query:"endpoint_name"`
	// model label
	ModelTagList []*ModelTag `thrift:"model_tag_list,15,optional,list<ModelTag>" form:"model_tag_list" json:"model_tag_list,omitempty" query:"model_tag_list"`
...
type GetTypeListData struct {
	ModelList    []*Model     `thrift:"model_list,1,default,list<Model>" form:"model_list" json:"model_list" query:"model_list"`
	VoiceList    []*VoiceType `thrift:"voice_list,2,default,list<VoiceType>" form:"voice_list" json:"voice_list" query:"voice_list"`
	RawModelList []*Model     `thrift:"raw_model_list,3,default,list<Model>" form:"raw_model_list" json:"raw_model_list" query:"raw_model_list"`
}
...
type CheckDraftBotCommitData struct {
	Status *CommitStatus `thrift:"status,1,optional,CommitStatus" form:"status" json:"status,omitempty" query:"status"`
...
type PublishConnectorInfo struct {
	...
	ConfigStatus ConfigStatus `thrift:"config_status,6,required,ConfigStatus" form:"config_status,required" json:"config_status,required" query:"config_status,required"`
	// Last Post
	...
	BindType BindType `thrift:"bind_type,8,required,BindType" form:"bind_type,required" json:"bind_type,required" query:"bind_type,required"`
	...
	// bot channel status
	ConnectorStatus *BotConnectorStatus `thrift:"connector_status,13,optional,BotConnectorStatus" form:"connector_status" json:"connector_status,omitempty" query:"connector_status"`
	// Privacy Policy
	...
	AllowPunish *AllowPublishStatus `thrift:"allow_punish,16,optional,AllowPublishStatus" form:"allow_punish" json:"allow_punish,omitempty" query:"allow_punish"`
...
type PublishConnectorListResponse struct {
	Code                  int64                   `thrift:"code,1" form:"code" json:"code" query:"code"`
	Msg                   string                  `thrift:"msg,2" form:"msg" json:"msg" query:"msg"`
	PublishConnectorList  []*PublishConnectorInfo `thrift:"publish_connector_list,3,default,list<PublishConnectorInfo>" form:"publish_connector_list" json:"publish_connector_list" query:"publish_connector_list"`
