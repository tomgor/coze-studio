...
type PluginInfo struct {
	...
	PluginFrom *PluginFrom `thrift:"PluginFrom,99,optional,PluginFrom" form:"plugin_from" json:"plugin_from,omitempty"`
	// api version
...
type ShortcutCommandToolInfo struct {
	...
	Params        []*ShortcutToolParam `thrift:"params,6,optional,list<ShortcutToolParam>" form:"params" json:"params,omitempty" query:"params"`
}
