...
type ResourceInfo struct {
	...
	// resource type
	ResType *ResType `thrift:"ResType,2,optional,ResType" json:"res_type" form:"ResType" query:"ResType"`
	...
	PublishStatus *PublishStatus `thrift:"PublishStatus,11,optional,PublishStatus" json:"publish_status" form:"PublishStatus" query:"PublishStatus"`
	...
	Actions []*ResourceAction `thrift:"Actions,17,optional,list<ResourceAction>" json:"actions" form:"Actions" query:"Actions"`
...
type ProjectResourceAction struct {
	// An operation corresponds to a unique key, and the key is constrained by the resource side
	Key ProjectResourceActionKey `thrift:"Key,1,required,ProjectResourceActionKey" json:"key" form:"Key,required" query:"Key,required"`
	//ture = can operate this Action, false = grey out
	Enable bool `thrift:"Enable,2,required" json:"enable" form:"Enable,required" query:"Enable,required"`
...
type ProjectResourceInfo struct {
	...
	// Different types of different operation buttons are agreed upon by the resource implementer and the front end. Return is displayed, if you want to hide a button, do not return;
	Actions []*ProjectResourceAction `thrift:"Actions,3,default,list<ProjectResourceAction>" json:"actions" form:"Actions" query:"Actions"`
	// Is the user read-only to the resource?
	//    4: bool ReadOnly (go.tag = "json:\"read_only\"", agw.key = "read_only")
	// resource type
	ResType ResType `thrift:"ResType,5,default,ResType" json:"res_type" form:"ResType" query:"ResType"`
...
type ProjectResourceGroup struct {
	// resource grouping
	GroupType    ProjectResourceGroupType `thrift:"GroupType,1,default,ProjectResourceGroupType" json:"group_type" form:"GroupType" query:"GroupType"`
	ResourceList []*ProjectResourceInfo   `thrift:"ResourceList,2,optional,list<ProjectResourceInfo>" json:"resource_list" form:"ResourceList" query:"ResourceList"`
}
...
type ResourceCopyFailedReason struct {
	ResID   int64   `thrift:"ResID,1" form:"res_id" json:"res_id,string"`
	ResType ResType `thrift:"ResType,2,default,ResType" json:"res_type" form:"ResType" query:"ResType"`
...
type ResourceCopyTaskDetail struct {
	...
	// task status
	Status TaskStatus `thrift:"status,2,default,TaskStatus" form:"status" json:"status" query:"status"`
	// Replicated resource id
	ResID   int64             `thrift:"res_id,3" form:"res_id" json:"res_id,string" query:"res_id"`
	ResType ResType           `thrift:"res_type,4,default,ResType" form:"res_type" json:"res_type" query:"res_type"`
	Scene   ResourceCopyScene `thrift:"scene,5,default,ResourceCopyScene" form:"scene" json:"scene" query:"scene"`
