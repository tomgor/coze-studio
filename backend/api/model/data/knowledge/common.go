...
type ChunkStrategy struct {
	...
	ChunkType ChunkType `thrift:"chunk_type,5,default,ChunkType" form:"chunk_type" json:"chunk_type" query:"chunk_type"`
	// Image type, image description text annotation method
	CaptionType *CaptionType `thrift:"caption_type,7,optional,CaptionType" form:"caption_type" json:"caption_type,omitempty" query:"caption_type"`
	//segmented overlap
...
type ParsingStrategy struct {
	//parse type
	ParsingType *ParsingType `thrift:"parsing_type,1,optional,ParsingType" form:"parsing_type" json:"parsing_type,omitempty" query:"parsing_type"`
...
type FilterStrategy struct {
	//filter pages
	FilterPage []int32 `thrift:"filter_page,1,optional,list<i32>" form:"filter_page" json:"filter_page,omitempty" query:"filter_page"`
}
