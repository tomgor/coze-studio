...
type Dataset struct {
	...
	// file list
	FileList []string `thrift:"file_list,3,default,list<string>" form:"file_list" json:"file_list" query:"file_list"`
	// All file sizes
	...
	Status       DatasetStatus `thrift:"status,6,default,DatasetStatus" form:"status" json:"status" query:"status"`
	// List of file names in process, compatible with old logic
	ProcessingFileList []string `thrift:"processing_file_list,7,default,list<string>" form:"processing_file_list" json:"processing_file_list" query:"processing_file_list"`
	...
	FailedFileList []string   `thrift:"failed_file_list,18,default,list<string>" form:"failed_file_list" json:"failed_file_list" query:"failed_file_list"`
	FormatType     FormatType `thrift:"format_type,19,default,FormatType" form:"format_type" json:"format_type" query:"format_type"`
	// number of segments
	...
	ProcessingFileIDList []string `thrift:"processing_file_id_list,24,default,list<string>" form:"processing_file_id_list" json:"processing_file_id_list" query:"processing_file_id_list"`
	//project ID
