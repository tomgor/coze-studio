...
type PhotoInfo struct {
	...
	// status
	Status DocumentStatus `thrift:"status,10,default,DocumentStatus" form:"status" json:"status" query:"status"`
	// source
	SourceType DocumentSource `thrift:"source_type,11,default,DocumentSource" form:"source_type" json:"source_type" query:"source_type"`
}
...
type DocumentProgress struct {
	...
	Status   DocumentStatus `thrift:"status,3,default,DocumentStatus" form:"status" json:"status" query:"status"`
